		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Deseja realmente cancelar interesse?</h4>
			  </div>
			  
			  <div class="modal-footer">
				<form class="form-horizontal" role="form" method="post" action="../controller/controlaInteresseServico.php">
					<input type="hidden" name="codigo" value="<?php echo $codigo; ?>">
					<input type="submit" class="btn btn-danger" name="operacao" value="Sim"/>
					<a class="btn btn-primary" href=../view/interesseServicos.php?idServico=<?php echo $codigo ?>>Não</a>
